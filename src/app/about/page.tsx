...
export const metadata = getMetadata(
    "Over Mij - AR EasyWeb | Webdesigner in West-Vlaanderen",
    "Leer mij kennen: freelance webdeveloper gespecialiseerd in moderne websites voor kleine KMO’s in West-Vlaanderen. Mijn ervaring, aanpak en technologieën.", // kleine locale toevoeging
    "/about",
    "https://areasyweb.be/og-aboutimage.png"
);
            ...
            <Script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify(
                        getWebPageSchema(
                            "Over Mij - AR EasyWeb | Webdesigner in West-Vlaanderen",
                            "Leer mij kennen: freelance webdeveloper gespecialiseerd in moderne websites voor kleine KMO’s in West-Vlaanderen",
                            "https://areasyweb.be/about"
                        )
                    ),
                }}
